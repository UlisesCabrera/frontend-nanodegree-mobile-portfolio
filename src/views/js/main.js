...
function updatePositions() {
    ...
    var scroll_top = document.body.scrollTop; // put he location of this event out of the loop so it does not get call each time the loops gets called -uc
